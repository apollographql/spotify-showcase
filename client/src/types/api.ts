...
export type SettingsQuery = { __schema: { __typename: '__Schema', types: Array<{ __typename: '__Type', name: string | null, kind: __TypeKind, fields: Array<{ __typename: '__Field', name: string, description: string | null }> | null }> }, developer: { __typename: 'Developer', fieldConfigs: Array<{ __typename: 'FieldConfig', timeout: number, errorRate: number, schemaField: { __typename: 'SchemaField', fieldName: string, typename: string } }> } };
