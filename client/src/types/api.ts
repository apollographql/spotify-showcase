...
export type QueueRouteQuery = { me: { __typename: 'CurrentUser', player: { __typename: 'Player', playbackQueue: { __typename: 'PlaybackQueue', currentlyPlaying: { __typename: 'Episode', id: string, durationMs: number, uri: string, show: { __typename: 'Show', id: string, name: string } } | { __typename: 'Track', id: string, durationMs: number, uri: string, trackNumber: number | null, explicit: boolean, name: string, album: { __typename: 'Album', id: string, name: string, images: Array<{ __typename: 'Image', url: string }> }, artists: Array<{ __typename: 'Artist', id: string, name: string }> } | null, queue: Array<{ __typename: 'Episode', id: string, durationMs: number, uri: string, show: { __typename: 'Show', id: string, name: string } } | { __typename: 'Track', id: string, durationMs: number, uri: string, trackNumber: number | null, explicit: boolean, name: string, album: { __typename: 'Album', id: string, name: string, images: Array<{ __typename: 'Image', url: string }> }, artists: Array<{ __typename: 'Artist', id: string, name: string }> }> } | null } } | null };

type QueueRoute_playbackItem_Episode_ = { __typename: 'Episode', id: string, durationMs: number, uri: string, show: { __typename: 'Show', id: string, name: string } };
...
export type SettingsQuery = { developer: { __typename: 'Developer', fieldConfigs: Array<{ __typename: 'FieldConfig', timeout: number, errorRate: number, schemaField: { __typename: 'SchemaField', fieldName: string, typename: string } }> }, __schema: { __typename: '__Schema', types: Array<{ __typename: '__Type', name: string | null, kind: __TypeKind, fields: Array<{ __typename: '__Field', name: string, description: string | null, type: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null } | null } | null } | null } | null } | null } | null } | null } }> | null }> } };
...
export type BareIntrospectionFragment = { __schema: { __typename: '__Schema', types: Array<{ __typename: '__Type', name: string | null, kind: __TypeKind, fields: Array<{ __typename: '__Field', name: string, description: string | null, type: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null, ofType: { __typename: '__Type', kind: __TypeKind, name: string | null } | null } | null } | null } | null } | null } | null } | null } }> | null }> } };
