...
export type ArtistTopTracks_tracks = { __typename: 'Track', id: string, durationMs: number, name: string, album: { __typename: 'Album', id: string, images: Array<{ __typename: 'Image', url: string }> } };
