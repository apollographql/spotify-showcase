...
export type QueueRouteQuery = { me: { __typename: 'CurrentUser', player: { __typename: 'Player', playbackQueue: { __typename: 'PlaybackQueue', currentlyPlaying: { __typename: 'Episode', id: string, durationMs: number, uri: string } | { __typename: 'Track', id: string, durationMs: number, uri: string, trackNumber: number | null, explicit: boolean, name: string, album: { __typename: 'Album', id: string, images: Array<{ __typename: 'Image', url: string }> }, artists: Array<{ __typename: 'Artist', id: string, name: string }> } | null, queue: Array<{ __typename: 'Episode', id: string, durationMs: number, uri: string } | { __typename: 'Track', id: string, durationMs: number, uri: string, trackNumber: number | null, explicit: boolean, name: string, album: { __typename: 'Album', id: string, images: Array<{ __typename: 'Image', url: string }> }, artists: Array<{ __typename: 'Artist', id: string, name: string }> }> } | null } } | null };

type QueueRoute_playbackItem_Episode_ = { __typename: 'Episode', id: string, durationMs: number, uri: string };
