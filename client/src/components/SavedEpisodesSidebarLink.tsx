...
import { SavedEpisodesSidebarLink_playbackState } from '../types/api';
...
const PLAYBACK_STATE_FRAGMENT: TypedDocumentNode<SavedEpisodesSidebarLink_playbackState> = gql`
  fragment SavedEpisodesSidebarLink_playbackState on PlaybackState {
    isPlaying
    context {
      uri
    }
...
const SavedEpisodesSidebarLink = () => {
  ...
  const id = 'collection:episodes';
  const uri = `spotify:user:${currentUserId}:collection:your-episodes`;
      ...
      <li>
        ...
        >
          <div className="flex gap-3 items-center">
            <YourEpisodesPlaylistCoverPhoto iconSize="1rem" size="3rem" />
...
export default SavedEpisodesSidebarLink;
